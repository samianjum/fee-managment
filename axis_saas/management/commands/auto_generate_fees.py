    ...
    def handle(self, *args, **options):
        ...
        for tenant in tenants:
            with schema_context(tenant.schema_name):
                ...
                # Check if fees already generated for this month (optional: if any record exists)
                ...
                for s in students:
                    ...
                    if base_fee == 0:
                        ...
                        if fee_struct:
                            ...
                            # Optionally update student custom_fee for future
                ...
                if created > 0:
                    self.stdout.write(f"{tenant.schema_name}: generated {created} fee records for {month}/{year}")
                if skipped_no_fee > 0:
                    self.stdout.write(f"{tenant.schema_name}: skipped {skipped_no_fee} students with no fee structure")
